...
# Small Problems Medium 1 - Problem 1: Listening Device
# Fri. 01/08/2021
...
Anything that is said is retrieved by this listening device via a block. If nothing is said, then no block will be passed in.
