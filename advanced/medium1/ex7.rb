...
# Small Problems Medium 1 - Problem 7: Bubble Sort with Blocks
# Fri. 01/08/2021
...
in reverse order from usual, or perhaps you want to sort a list of names in a case-insensitive manner.
...
#       current = array[index]
#       next if (block_given? ? yield(previous, current): previous <= current)
#       array[index - 1], array[index] = array[index], array[index - 1]
#       swapped = true
#     end
